...
**Status:** LEVANDE HUVUDKONTROLL

## A. Projektstatus i en blick

| Område | Huvudfråga | Nuvarande bevisläge | Kritisk lucka | Auditstatus |
|---|---|---|---|---|
| Brand 2017 | Vad hände och vad gjordes efteråt? | SSBF/polisspår stödjer brand-/rökhändelse. FB kontaktades enligt senare SSBF-underlag. | Sanerings-/skade-/entreprenörs-/försäkringskedjan efter insatsen är inte komplett redovisad. | AKTIV – PRIMÄRKÄLLOR DELVIS LÅSTA |
| Familjebostäders brandbesked 2025 | När fick FB uppgiften och vad uppgav de? | Skriftliga besked 24/25 nov + senare Jennifer-besked om sanering/dokumentationsbrist. | Exakt intern faktabas/arkivsökning hos FB. | STARK DOKUMENTKEDJA, MEN ORGANISATIONSKÄNNEDOM MÅSTE HÅLLAS ISÄR FRÅN ENSKILT BESKED |
| 11 nov-mötet | Vad sades om brand/kanalrensning/ventilation? | Mötet verifierat; flera sakuppgifter finns som förstahandsanteckning/transkriptionsspår. | Original-ljud måste låsa talare, ordalydelse och mötesidentitet. | SOURCE-LOCK KRÄVS FÖR EXAKTA CITAT |
| 17 dec-mötet | Besvarades kvarstående brand-/saneringsfrågor? | Aktiv anteckning och mejlkedja stödjer att frågor skulle tas upp. | Original mötes-/ljudunderlag + efterföljande mejl ska låsa vad som faktiskt inte hanns med. | SOURCE-LOCK KRÄVS |
| OCAB | Vad undersöktes faktiskt? | Rapport 716247 finns; arbetspositionen är att scope måste hållas strikt. | Originalbeställning/scope, mätpunkter/rådata och exakt slutsats. | KRITISK J4-KONTROLL |
| Ventilation | Vad mättes, ändrades och rensades? | Mät-/mejlspår 4 nov, senare kanalrensningsspår och OVK-handlingar. | Original arbetsorder/mätanteckning; exakt innebörd av `efter rensningen av kanal`; objekt/systemkoppling. | AKTIV |
| Kanalrensning | När uppstod förslaget och vad utfördes? | Skriftligt stöd 26 nov + mötesuppgifter. | Original för 11 nov; beställning, utförare, omfattning/längd, före-/efterkontroll. | SOURCE-LOCK + TEKNISK KOMPLETTERING |
...
## C. Högsta source-lock-prioritet

1. **11 november 2025 – mötet:** lås exakt vem som säger vad om brand, kanalrensning och ventilation.
2. **17 december 2025 – mötet:** lås vilka frågor som togs upp respektive inte togs upp.
3. **SSBF 16 november 2017:** håll själva insatsen, FB-kontakten och senare efterarbete strikt isär.
4. **OCAB 716247:** lås beställning/scope/metod/resultat.
...
När en handling saknas ska auditten skriva **vad frånvaron faktiskt innebär**:

- `ingen handling redovisad` ≠ `åtgärden skedde aldrig`,
...
Varje fullauditerad post ska få en av följande:

- `INNE I TIDSLINJE – KORREKT`
- `INNE I TIDSLINJE – BEHÖVER KORRIGERAS`
- `SAKNAS I TIDSLINJE`
- `FINNS ENDAST I TILLÄGG/SPÅR`
- `SKA INTE IN I FAKTATIDSLINJE – ANALYS/HYPOTES`

Ingen viktig faktisk händelse får finnas endast i ett separat sakspår.

## F. Status mot sakspår
...
## G. Kontrollfrågor som inte får tappas bort

- Vad är den faktiskt verifierade orsaken till det rapporterade inomhusmiljöproblemet – om någon sådan orsak har fastställts?
- Vilka tekniska frågor har faktiskt undersökts och vilka har inte undersökts?
- Vilken dokumentation finns från efterarbetet efter brand-/rökhändelsen 2017?
- När och på vilket underlag fick Familjebostäder kännedom om branduppgiften 2025, och hur förhåller det sig till SSBF:s uppgift om kontakt 2017?
- Vad omfattade kanalrensningen faktiskt?
...
När ny information kommer in ska kontrollpanelen inte bara få en ny rad. Den nya uppgiften ska först testas mot befintliga bevisposter och kan:

- stärka en post,
- försvaga en post,
- skapa motsägelse,
- fylla en dokumentationslucka,
- kräva att huvudtidslinjen korrigeras,
- ändra juridisk funktion,
- eller visa att ett tidigare externt argument varit för starkt.

**STORA AUDITEN ska därför fungera som projektets kvalitetssäkring – inte som ytterligare en berättelse om ärendet.**