# 00. AKTUELLT JURIDIK- OCH ÖVERKLAGANDEINDEX

**Datum:** 29 augusti 2026  
**Status:** AKTIV NAVIGERING – ska peka på aktuell huvudarbetsversion och styrande auditlager.

## Aktuell överklagandeversion

- `juridik/OVERKLAGAN-KANSKE-ERICA-M-5167-26-2026-08-29.md`
  - arbetsnamn: **Överklagan kanske Erica**
  - status: **POTENTIELL ÖVERKLAGANDEVERSION – INTE SLUTVERSION**
  - detta är den enda aktuella huvudarbetsversionen för ett möjligt MÖD-överklagande.

## Styrande release-gate

- `STORA-AUDITEN/15-OVERKLAGAN-KANSKE-ERICA-RELEASE-GATE-2026-08-29.md`

Ingen slutversion får expedieras innan denna kontroll är genomförd.

## Styrande juridiska auditer

1. `STORA-AUDITEN/11-MF-LANSSTYRELSEN-MMD-FYR-PDF-LAGUTNYTTJANDE-AUDIT-2026-08-29.md`
...
4. `STORA-AUDITEN/10-OBESVARADE-FRAGOR-MASTER-FB-MF-LST-MMD-2026-08-29.md` – **levande frågemaster, nu även HGF, svarsblankett, akt 95, kanalrensning och Aron Nabi**
...
- **27 oktober 2025:** akut felanmälan direkt till FB om kraftig lukt, huvudvärk och kraftigt smutsad ventilations-/fläktdel med nio fotografier. Ericas benämning `mögel/mikrobiell påväxt` är partsbedömning tills expertstöd finns.
- **27 oktober–5 november 2025:** fotodokumentation efter professionell städning visar kvarstående synliga mörka/bruna/svarta missfärgningar, smuts, rost och materialavvikelser i flera delar av bostaden. Bilderna får inte själva artbestämma mögel, sot eller kemiskt ämne.
...
- `juridik/OVERKLAGAN-KANSKE-ERICA-V2-FORBATTRINGSLAGER-2026-08-29.md` – fynden är införlivade i huvudarbetsversionen; behålls endast för spårbarhet.
- `juridik/UTKAST-MOD-OVERKLAGANDE-M-5167-26-2026-08-29.md` – äldre strategiskt utkast; inte aktuell version.

## Nuvarande juridiska huvudlinje

Överklagandet ska i första hand byggas kring:

1. **39 § 1 ärendelagen – ändringsdispens**
2. **39 § 2 ärendelagen – granskningsdispens**
3. **FL 23 + MB 2:1 + MB 26:21–22 – utredning/verifiering och teknisk informationsasymmetri**
4. **FL 27 → 10 → 25 → 32 – dokumentationskedjan kring tillsynen**
5. **LOMD 5:1 + ärendelagen 12 – domstolens utrednings-/processledningsansvar**
6. **återförvisning – fortsatt förstahandsutredning som huvudlösning**
...
Arbeta alltid från detta index när en ny version av överklagandet skapas. Äldre utkast får inte råka bli styrande igen.