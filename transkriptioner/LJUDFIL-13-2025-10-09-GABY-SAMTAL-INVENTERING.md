# Ljudfil 13 – 9 oktober 2025 – samtal med Gaby

**Status:** mottagen och registrerad som eget källspår. Innehållet ska fyndgranskas och låsas sekvensvis innan ordagranna citat används externt.

## Källfil

Uppladdad ljudfil: `9 okt - gaby samtal .m4a`

Teknisk längd: **25 min 06,091 sek**.
...
5. **Brukbarhet / uthyrningsklart skick**
   - Säger Gaby något som antyder att lägenheten ännu inte var helt klar eller att flera åtgärder återstod?
   - Finns formuleringar som senare kan jämföras med Familjebostäders påstående att bostaden varit fullt brukbar från dag 1?

## Bevismässig betydelse – preliminär

Den här filen kan bli viktig om Gaby redan den 9 oktober 2025:

- bekräftar flera kvarstående brister,
- beskriver behov av ytterligare åtgärder eller felsökning,
- eller visar att Familjebostäder fortfarande höll på att få bostaden i ordning efter att hyrestiden redan börjat.

Det skulle inte automatiskt bevisa att lägenheten juridiskt var obrukbar, men det kan utgöra ett tidigt och samtida motbevis mot en alltför kategorisk senare beskrivning av att lägenheten varit helt färdig och fullt brukbar från dag 1.

## Metodregel

Fynd ska klassificeras som:
- `TYDLIGT`
- `SANNOLIKT`
- `OSÄKERT`
- `BEHÖVER ERICAS KONTROLL`

Först efter Ericas egen kontroll mot tidskoden får ett viktigt citat markeras som låst för extern användning.
