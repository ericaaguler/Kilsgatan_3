...
**Datum för teknisk kontroll:** 22 augusti 2026  
**Syfte:** hålla isär unika inspelningar, exakta kopior och alternativa inspelningar från samma tillfälle innan innehållet används som bevis.

## Arbetsmetod

För varje tillfälle ska ljudet granskas i två steg:

1. **Fyndgenomgång:** relevanta sekvenser markeras som `TYDLIGT`, `SANNOLIKT`, `OSÄKERT` eller `BEHÖVER ERICAS KONTROLL`.
2. **Låsning:** Erica lyssnar på de markerade tiderna och bekräftar eller korrigerar ordalydelsen innan citat används externt.

Om två filer kommer från samma tillfälle jämförs de för att avgöra om de är:
- exakt samma ljuddata/kopia,
...
**Teknisk slutsats:** exakt samma avkodade ljuddata. Detta är två kopior av samma inspelning, inte två oberoende apparater.
...
- `11 nov 2025 1mötet med FB torsbygatan tomas är med .m4a` – 90:53,440
- `Nov 1:a möte med Jennifer gaby, mike tommas torsby 11 november 2025 .m4a` – 90:53,440
...
**Status:** unik kort fil i nuvarande lokala material.

### 11 mars 2026 – Stina Jurell / Miljöförvaltningen
...
**Status:** unik fil i nuvarande lokala material. Hög prioritet för fyndgenomgång, särskilt när Thomas kommer in.

### 10 juli 2026 – Marko platsbesök
- `10 juni med marko husvärd.m4a` – 48:09,429. Filnamnet säger 10 juni men metadata visar 10 juli 2026; detta måste beskrivas försiktigt och låsas mot övrig dokumentation.
- `Marco del 1.m4a` – 29:50,357
- `Marco del 2 ha.m4a` – 14:58,837

**Teknisk jämförelse:**
- `Marco del 1` motsvarar en del av den längre inspelningen och börjar ungefär vid **02:16** i helfilen.
